...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const authModalEdit = document.querySelector("#auth-modal-edit");
    createBtn.addEventListener("click", function (e) {
        authModalEdit.classList.add("show");

        // console.log(authModalEdit);
    });
    const modalCloseEdit = document.querySelector("#modalCloseEdit");
    modalCloseEdit.addEventListener("click", function () {
        authModalEdit.classList.remove("show");
    });
});
